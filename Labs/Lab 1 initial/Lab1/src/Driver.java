...
public class Driver {
    ...
    public static boolean testBruteForce=true;
    public static boolean testGS=false;
    
    public static void main(String[] args) throws Exception {
        //parseArgs();
        
        Matching problem = parseMatchingProblem("/Users/dhruvsandesara/Desktop/Lab1TesterScript/test_code/small_inputs/10.in");
        testRun(problem);
    }
